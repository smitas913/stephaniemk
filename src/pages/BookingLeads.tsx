...
export default function BookingLeads() {
  ...
  // Add/edit form state
  const [form, setForm] = useState({ name: "", phone: "", email: "", lead_source: "", notes: "", next_follow_up_date: "" });

  const resetForm = () => setForm({ name: "", phone: "", email: "", lead_source: "", notes: "", next_follow_up_date: "" });
