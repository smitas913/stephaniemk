...
const HEADER_HINTS: Record<DestField, string[]> = {
  ...
  last_contacted: ["last_contacted", "last contacted", "last contact", "last contact date", "last_contact_date", "contacted", "date last contacted", "last activity", "last activity date", "contact date", "date contacted", "date_last_contacted"],
