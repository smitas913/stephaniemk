...
export const DEFAULT_BUSINESS_GOALS: Omit<BusinessGoal, "id" | "user_id">[] = [
  ...
  { metric_key: "sales_stretch", metric_label: "Monthly Stretch Sales", period: "monthly", goal_value: 0, manual_actual: null, auto_track_key: null, unit: "currency", is_visible: false, sort_order: 3 },
  { metric_key: "profit_goal", metric_label: "Monthly Profit Goal", period: "monthly", goal_value: 0, manual_actual: null, auto_track_key: null, unit: "currency", is_visible: false, sort_order: 4 },
];
